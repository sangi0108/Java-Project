...
{
	static String url = "https://finsight.com/api/deals/recently-priced/?page={0}&sector_primary=CMBS&sector_secondary=Large-Loan+%2F+SASB&sectors_excluded=";
	...
	public static void writeToExcel() 
	{
		...
		try
		{
		    ...
		    XSSFSheet sheet = workbook.createSheet("SASB");
	        ...
	        FileOutputStream out = new FileOutputStream(new File("FinSight_SASB.xlsx"));
	        workbook.write(out);
	        out.close();
