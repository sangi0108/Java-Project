...
{
	static String url = "https://finsight.com/api/deals/recently-priced/?page= {0}&sector_primary=CMBS&sector_secondary=Other&sectors_excluded=";
	...
	public static void writeToExcel() 
	{
		...
		try
		{
		    ...
		    XSSFSheet sheet = workbook.createSheet("Others");
	        ...
	        FileOutputStream out = new FileOutputStream(new File("FinSight_Others.xlsx"));
	        workbook.write(out);
	        out.close();
