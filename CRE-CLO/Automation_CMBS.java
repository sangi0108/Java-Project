...
{
	static String url = "https://finsight.com/api/deals/recently-priced/?page={0}&sector_primary=CMBS&sector_secondary=CRE-CLO&sectors_excluded=";
	...
	public static void writeToExcel() 
	{
		...
		try
		{
		    ...
		    XSSFSheet sheet = workbook.createSheet("CRE-CLO");
	        ...
	        FileOutputStream out = new FileOutputStream(new File("FinSight_CRE-CLO.xlsx"));
	        workbook.write(out);
	        out.close();
